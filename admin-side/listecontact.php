...
<div class="container">
    ...
    $contactList = $contactController->contactList();
    ...
    if ($contactList) {
        foreach ($contactList as $contact) {
            ...
            echo "<td><button class='btn btn-danger' onclick='confirmDelete(\"{$contact['name']}\")'>Delete</button></td>";
            echo "</tr>";
        }
    }
    ?>
...
<script>
    function confirmDelete(name) {
        ...
        if (result) {
            window.location.href = 'deletecontact.php?name=' + encodeURIComponent(name) + '&confirm=true';
        }
    }
</script>
