...
<form action="edituser_action.php" method="post">
    <div class="form-group">
        ...
        <input type="text" name="id" value="<?php echo $user['userid'] ?>" readonly class="form-control">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="password" name="password" value="<?php echo $user['password'] ?>" required class="form-control">
    </div>
