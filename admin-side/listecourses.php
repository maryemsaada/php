...
<script>
    function confirmDelete(idCourse) {
        ...
        if (result) {
            window.location.href = 'delete.php?idCourse=' + idCourse + '&confirm=true';
        }
    }
</script>
<header>
        ...
        <div class="card-body">
            <table class="table">
                ...
                <tbody>
                    ...
                    $courses = $coursesController->coursesList();
                    ...
                    foreach ($courses as $course) {
                        ...
                        if (!empty($course['categoryName'])) {
                            echo $course['categoryName'];
                        } else {
                            echo "N/A";
                        }
                        echo "</td>";
                        echo "<td><img src='{$course['image']}' alt='Course Image' style='width: 100px;'></td>";
                        echo "<td><button class='btn btn-danger' onclick=\"confirmDelete({$course['idCourse']})\">Delete</button></td>";
                        echo "<td><a href='edit.php?id={$course['idCourse']}' class='btn btn-warning'>Edit</a></td>";
                        echo "</tr>";
                    }
                    ?>
                </tbody>
