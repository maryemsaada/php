...
<script>
    function confirmDelete(categoryName) {
        ...
        if (result) {
            window.location.href = 'deletecat.php?categoryName=' + categoryName + '&confirm=true';
        }
    }
</script>
        ...
        <div class="card-body">
            <table class="table">
                ...
                <tbody>
                    ...
                    $category = $categoryController->categoriesList();

                    foreach ($category as $categoryy) {
                        echo "<tr>";
                        echo "<td>{$categoryy['categoryName']}</td>";
                        echo "<td><img src='{$categoryy['image']}' alt='Category Image' style='width: 100px;'></td>";
                        echo "<td><button class='btn btn-danger' onclick=\"confirmDelete('{$categoryy['categoryName']}')\">Delete</button></td>";
                        echo "<td><a href='editcat.php?id={$categoryy['categoryName']}' class='btn btn-warning'>Edit</a></td>";
                        echo "</tr>";
                    }
                    ?>
                </tbody>
